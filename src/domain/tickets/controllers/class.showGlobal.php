...
namespace leantime\domain\controllers {
    ...
    class showGlobal
    {
        ...
        {
            $searchCriteria = $this->ticketService->prepareTicketSearchArray($params, true);

            $this->tpl->assign('allTickets', $this->ticketService->getAllGlobal($searchCriteria));
            ...
            $this->tpl->display('tickets.showGlobal');
        }
    }
}
